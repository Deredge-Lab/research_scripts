...
set title "System-Name Avg C{/Symbol a} RMSF"
set xlabel "Residue"
set ylabel "RMSF ({\305})"
...
set output "system-name_rmsf.png";
plot "system-name_rmsf_rep1.dat" u ($1/10):($2) w lines t "Rep 1" lw 6, \
"system-name_rmsf_rep2.dat" u ($1/10):($2) w lines t "Rep 2" lw 6, \
"system-name_rmsf_rep3.dat" u ($1/10):($2) w lines t "Rep 3" lw 6, \
